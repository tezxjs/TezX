...
let GlobalConfig = class {
  ...
  static get debugging() {
    return this.debugMode
      ? {
          info: (msg, ...args) =>
            (0, debugging_1.loggerOutput)("info", msg, ...args),
          warn: (msg, ...args) =>
            (0, debugging_1.loggerOutput)("warn", msg, ...args),
          error: (msg, ...args) =>
            (0, debugging_1.loggerOutput)("error", msg, ...args),
          debug: (msg, ...args) =>
            (0, debugging_1.loggerOutput)("debug", msg, ...args),
          success: (msg, ...args) =>
            (0, debugging_1.loggerOutput)("success", msg, ...args),
        }
      : {
          info: (msg, ...args) => {},
          warn: (msg, ...args) => {},
