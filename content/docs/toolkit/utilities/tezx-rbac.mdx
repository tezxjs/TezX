---
title: RBAC
description: A powerful, fully type-safe Role-Based Access Control (RBAC) plugin for [TezX](https://www.npmjs.com/package/tezx), designed to help you control access to routes, APIs, and resources using simple, template-based permission keys with full IntelliSense support.
---
