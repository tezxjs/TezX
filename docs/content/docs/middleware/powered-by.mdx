---
title: poweredBy
description: Middleware for adding an X-Powered-By header to HTTP responses. This is commonly used to indicate the server or framework powering the application.
---
