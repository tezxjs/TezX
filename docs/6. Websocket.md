...
export type WebSocketOptions = {
  ...
  protocols?: string[]; // ✅ Deno: Supported subprotocols
...
```typescript
export function upgradeWebSocket(callback: WebSocketCallback, options: WebSocketOptions = {}): Middleware;
```
