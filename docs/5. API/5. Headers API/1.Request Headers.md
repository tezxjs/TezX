...
forEach: function forEach(callback: ( key: string, value: string[]) => void): void {
...
### 7. `forEach(callback: ( key: string,values: string[]) => void): void`
...
```typescript
ctx.req.headers.forEach(( key ,values) => {
